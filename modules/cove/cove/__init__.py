...
llm = ChatOpenAI(model='qwen-plus',
                 temperature=0, base_url='https://api.chatfire.cn/v1', api_key='sk-Zd8c0F04pLszDvb97gu2YW1yaTS1OyFJzYlop3Qp14O61xn0')
# llm = ChatOpenAI(model_name="deepseek-chat", api_key='sk-3625a61902224bfc55c542c5d68d1824', base_url='https://api.deepseek.com')
